...
// AddDisabled appends an un-clickable menu item — useful for section
// headers and inline statistics.
func (m *Menu) AddDisabled(label string) *Menu {
	m.impl.AddDisabled(label)
	return m
}
